"""Create ERP-style workshop process detail records."""

from collections.abc import Sequence
import sqlalchemy as sa
from alembic import op

# This revision was already deployed as 20260811_17. Keep the deployed ID so
# existing databases and fresh installs share one migration graph.
revision: str = "20260811_17"
down_revision: str | Sequence[str] | None = "20260813_16"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    op.drop_index("ix_workshop_process_order", table_name="workshop_process_records")
    op.drop_index("ix_workshop_process_pending_due", table_name="workshop_process_records")
    op.drop_index("ix_workshop_process_reported", table_name="workshop_process_records")
    op.drop_table("workshop_process_records")
